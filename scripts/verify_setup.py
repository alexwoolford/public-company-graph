...
def check_neo4j_connection():
    ...
    try:
        ...
        try:
            ...
            version_result = gds.version()
            print(f"✓ GDS library available")
            gds.close()
        except Exception as e:
...
def check_graph_data():
    ...
    try:
        ...
        with driver.session(database=NEO4J_DATABASE) as session:
            ...
            if uses_count == 0:
                print("   ⚠️  WARNING: No USES relationships found. Run bootstrap_graph.py --execute")
...
def check_gds_features():
    ...
    try:
        ...
        with driver.session(database=NEO4J_DATABASE) as session:
            ...
            if adopt_count == 0:
                print("   ⚠️  WARNING: No adoption predictions found. Run compute_advanced_gds_features.py --execute")
            ...
            if cooccurs_count == 0:
                print("   ⚠️  WARNING: No affinity relationships found. Run compute_advanced_gds_features.py --execute")
